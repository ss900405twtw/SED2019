...
\begin{itemize}
	...
	\begin{itemize}
	    ...
	    \item URLs are mapped directly to Python modules and function calls, which return dictionary for rendering
	\end{itemize}
	...
	\item PPT
	\begin{itemize}
	    \item \href{https://docs.google.com/presentation/d/1uQHmO47PwgqEDylqxyjgr37IYh_oGdf94MUCg4qArVA/edit?fbclid=IwAR08jOlPbeA4ZIqqtgED0Gf7S-FwB-DlT9qz0WFAjOglYBXAQgkgvSiO69o#slide=id.g650747904c_35_104}{Overall structure, request-response flow and pydal}
    \end{itemize}	 
\end{itemize} \\
